...
MASTER_SSH_INFO=${MASTER_SSH_INFO:-"vagrant:vagrant@192.168.205.21"}

# ssh information for nodes (comma separated string).
NODE_SSH_INFO=${NODE_SSH_INFO:-"vagrant:vagrant@192.168.205.31,vagrant:vagrant@192.168.205.32"}
