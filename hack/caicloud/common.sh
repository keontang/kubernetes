...
CAICLOUD_KUBE_VERSION=${CAICLOUD_KUBE_VERSION:-"v1.2.0_0.8.2"}

CAICLOUD_DOCKER_REGISTRY=${CAICLOUD_DOCKER_REGISTRY:-"index.caicloud.io"}
CAICLOUD_DOCKER_REGISTRY_USERNAME=${CAICLOUD_DOCKER_REGISTRY_USERNAME:-"caicloud"}
# ugly
CAICLOUD_DOCKER_REGISTRY_PASSWORD=${CAICLOUD_DOCKER_REGISTRY_PASSWORD:-"caicloud2015ABC"}
